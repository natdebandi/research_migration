...
censo_salud_arg_1 <- read_excel("data/CENSO_salud.xlsx", sheet = "Hoja2")
censo_salud_arg_2 <- read_excel("data/CENSO_salud.xlsx", sheet = "Hoja3")
...
censo_salud_arg_1 <- censo_salud_arg_1 %>%
  rename(Salud = "...2", Mujer = `Mujer / Femenino`, Hombre = `Varón / Masculino`) %>%
